...
public partial class ExprParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IExprParserVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitReference([NotNull] ExprParser.ReferenceContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitPlainint([NotNull] ExprParser.PlainintContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitPlainstring([NotNull] ExprParser.PlainstringContext context) { return VisitChildren(context); }
	/// <summary>
