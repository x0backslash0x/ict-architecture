...
public partial class ExprParserBaseListener : IExprParserListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterReference([NotNull] ExprParser.ReferenceContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="ExprParser.reference"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitReference([NotNull] ExprParser.ReferenceContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="ExprParser.plainint"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterPlainint([NotNull] ExprParser.PlainintContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="ExprParser.plainint"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitPlainint([NotNull] ExprParser.PlainintContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="ExprParser.plainstring"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterPlainstring([NotNull] ExprParser.PlainstringContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="ExprParser.plainstring"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitPlainstring([NotNull] ExprParser.PlainstringContext context) { }
	/// <summary>
